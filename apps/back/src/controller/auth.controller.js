...
const registerUsers = async (req, res) => {
    try {
        ...
        await db.query("INSERT INTO user (username, email, password) VALUES (?,?,?)", [username, email, hashPass]);
...
const getMe = async (req, res) => {
    ...
    const [row] = await db.query("SELECT id, username, email, role FROM user WHERE id =?", [userId]);
